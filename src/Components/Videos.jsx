...
import { Stack,VStack,Heading,Text,Button,Box } from '@chakra-ui/react'
...
export default function Videos() {
  ...
  return (
   ...
   <Stack direction={['column','row']} h={'100vh'}>
    <VStack w={'full'}>
    <video src={videoSrc} controls controlsList='nodownload' style={{
        width:'100%',
    }} >
...
<VStack alignItems={'flex-start'} p={8} w={'full'} overflowY={'auto'}>        
    ...
    <VStack alignItems={'stretch'}p={8}  overflowY={'auto'} w={['full', 'xl']} spacing={6}>

{


    videosArr.map((item,index)=>(
<Button colorScheme='cyan'onClick={() => setVideoSrc(item)}
>
    Video {index+1}
</Button>
    ))
